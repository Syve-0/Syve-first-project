    ...
    <style>
        ...
        *{
        ...
        .container{
            position: relative;
            width:400px;
            /* min-height: 400px;  移除最小高度，让 JS 控制 */
            background:rgb(255,255,255,0.1);
            border-radius: 10px;
            display: flex;
            justify-content: center;
        ...
        :root {
            --toast-bg: #ffffff;
            --toast-text: #334155;
            /* 注意：这里只保留了背景色变量，图标颜色变量已被移除，因为外部SVG自身应携带颜色 */
...
<script>
    ...
    function showToast(message, isSuccess) {
        ...
        //ai的代码. 执行播放  .play() 返回一个 Promise，最好处理一下异常（比如浏览器拦截）
